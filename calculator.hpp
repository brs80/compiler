...
{
public:
  Calculator(Symbol_table& syms, std::string const& input);
...
public:
  ...
  int parse_additive_expression_rest(int);
  ...
  int parse_multiplicative_expression_rest(int);
  ...
  int parse_postfix_expression_rest(int);
